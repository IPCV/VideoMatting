...
#SBATCH -o Experiments/MobileOne-S0/exp_00/stage1/stage1.out           # STDOUT
#SBATCH -e Experiments/MobileOne-S0/exp_00/stage1/stage1.err           # STDERR
...
singularity exec --nv /gpfs/projects/ehpc176/Projects2/MambaMatting/matmat.sif \
    python /gpfs/scratch/ehpc176/Projects/Finetuning/mobileone_train.py \
    ...
    --checkpoint-dir Experiments/MobileOne-S0/exp_00/stage1/checkpoint/ \
    --log-dir Experiments/MobileOne-S0/exp_00/stage1/tensorboard/ \
    --epoch-start 0 \
    --epoch-end 20
